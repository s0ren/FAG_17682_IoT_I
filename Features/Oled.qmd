...
**Bemærk**: I sourcen herunder, refereres *også* til namespace'et `using Iot.Device.Ssd13xx.Samples;`, men det er ***ikke*** et assembly eller en NuGet pakke, men bare defineret i to filer, som ligger med i projektet (**BasicFont.cs** og **DoubleByteFont.cs**).
